    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="createModalLabel">Create entry for a book</h1>
            ...
            <div class="modal-body">
                <form id="createForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="createAuthor" name="author">
                    </div>
                    <div class="mb-3">
            ...
            <div class="alert alert-warning" role="alert" id="modalCreateWarning">An error ocurred. The book has not been created.</div>
...
<div class="modal fade" id="reviewModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="reviewModalLabel">Add Review</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="reviewForm">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="modalReviewButton">Add Review</button>
            </div>
        </div>
    </div>
</div>