...
<html lang="es" class="h-100" data-bs-theme="auto">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="flex-shrink-0">
            <div class="container">
                <h1 class="mt-5">Libros</h1>
                <p class="lead">
                    Bienvenido a ReviewsApp. Cuéntanos qué libros has leído y qué opinas de ellos.
                </p>
                @auth

                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal" data-url="/book">
                        Agregar Libro
                    </button>
                @endauth
